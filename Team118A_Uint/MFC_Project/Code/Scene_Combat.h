...
class CWorldCreator;
class CScene_Combat final: public CScene
{
private:
	CScene_Combat(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CScene_Combat();

public:
	static CScene_Combat*	Create(LPDIRECT3DDEVICE9 pGraphicDev);
