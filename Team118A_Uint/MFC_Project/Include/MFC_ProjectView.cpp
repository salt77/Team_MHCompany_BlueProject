...
// MFC_ProjectView.cpp : CMFC_ProjectView 클래스의 구현
//
...
CMFC_ProjectDoc* CMFC_ProjectView::GetDocument() const // 디버그되지 않은 버전은 인라인으로 지정됩니다.
{
