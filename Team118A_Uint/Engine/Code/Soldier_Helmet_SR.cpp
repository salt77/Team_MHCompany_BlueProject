...
CSoldier_Helmet_SR::CSoldier_Helmet_SR(LPDIRECT3DDEVICE9 pGraphicDev, E_OBJTAG eObjTag)
	:CMonster(pGraphicDev, eObjTag, L"Soldier_Helmet_SR")
{
}

CSoldier_Helmet_SR::CSoldier_Helmet_SR(const CSoldier_Helmet_SR & rhs)
	:CMonster(rhs)
{
}

CSoldier_Helmet_SR::~CSoldier_Helmet_SR()
{
}

CSoldier_Helmet_SR * CSoldier_Helmet_SR::Create(LPDIRECT3DDEVICE9 pGraphicDev, E_OBJTAG eObjTag)
{
	CSoldier_Helmet_SR* pInstance = new CSoldier_Helmet_SR(pGraphicDev, eObjTag);
...
void CSoldier_Helmet_SR::Free()
{
	CMonster::Free();
}

HRESULT CSoldier_Helmet_SR::Ready_Object()
{
...
_int CSoldier_Helmet_SR::Start_Object(const _float & fTimeDelta)
{
...
_int CSoldier_Helmet_SR::Update_Object(const _float & fTimeDelta)
{
...
_int CSoldier_Helmet_SR::LateUpdate_Object(const _float & fTimeDelta)
{
...
void CSoldier_Helmet_SR::Render_Object(_int iPass)
{
	CMonster::Render_Object(iPass);
}

void CSoldier_Helmet_SR::Set_Constantable()
{
	CMonster::Set_Constantable();
}

void CSoldier_Helmet_SR::OnEnable()
{
	CMonster::OnEnable();
}

void CSoldier_Helmet_SR::OnDisable()
{
	CMonster::OnDisable();
}

void CSoldier_Helmet_SR::OnDestroy()
{
	CMonster::OnDestroy();
}

void CSoldier_Helmet_SR::Trigger_Attack_1()
{
	Hit_Target();
