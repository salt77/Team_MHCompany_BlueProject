...
CDroid_Helmet_SMG::CDroid_Helmet_SMG(LPDIRECT3DDEVICE9 pGraphicDev, E_OBJTAG eObjTag)
	:CMonster(pGraphicDev, eObjTag, L"Droid_Helmet_SMG")
{
}

CDroid_Helmet_SMG::CDroid_Helmet_SMG(const CDroid_Helmet_SMG & rhs)
	:CMonster(rhs)
{
}

CDroid_Helmet_SMG::~CDroid_Helmet_SMG()
{
}

CDroid_Helmet_SMG * CDroid_Helmet_SMG::Create(LPDIRECT3DDEVICE9 pGraphicDev, E_OBJTAG eObjTag)
{
	CDroid_Helmet_SMG* pInstance = new CDroid_Helmet_SMG(pGraphicDev, eObjTag);
...
void CDroid_Helmet_SMG::Free()
{
	CMonster::Free();
}

HRESULT CDroid_Helmet_SMG::Ready_Object()
{
...
_int CDroid_Helmet_SMG::Start_Object(const _float & fTimeDelta)
{
...
_int CDroid_Helmet_SMG::Update_Object(const _float & fTimeDelta)
{
...
_int CDroid_Helmet_SMG::LateUpdate_Object(const _float & fTimeDelta)
{
...
void CDroid_Helmet_SMG::Render_Object(_int iPass)
{
	CMonster::Render_Object(iPass);
}

void CDroid_Helmet_SMG::Set_Constantable()
{
	CMonster::Set_Constantable();
}

void CDroid_Helmet_SMG::OnEnable()
{
	CMonster::OnEnable();
}

void CDroid_Helmet_SMG::OnDisable()
{
	CMonster::OnDisable();
}

void CDroid_Helmet_SMG::OnDestroy()
{
	CMonster::OnDestroy();
}

void CDroid_Helmet_SMG::Trigger_Attack_1()
{
	Hit_Target();
