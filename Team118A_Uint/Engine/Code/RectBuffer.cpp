...
CRectBuffer::CRectBuffer(LPDIRECT3DDEVICE9 pGraphicDev)
	: CVIBuffer(pGraphicDev)
{
	m_wstrComTag = ComTag_RectBuffer;
}

CRectBuffer::CRectBuffer(const CRectBuffer& rhs)
	:CVIBuffer(rhs)
{

}

CRectBuffer::~CRectBuffer()
{
}
...
CRectBuffer * CRectBuffer::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CRectBuffer*	pInstance = new CRectBuffer(pGraphicDev);
...
HRESULT CRectBuffer::Ready_Buffer()
{
	m_dwTriCnt = 2;
	m_dwVtxCnt = 4;
...
void CRectBuffer::Render_Buffer()
{
	CVIBuffer::Render_Buffer();
}

_bool CRectBuffer::Picking_Buffer(HWND hwnd, _vec3 * pOutPos, _float * pOutDist, _matrix _matWorld)
{
	POINT	ptMouse{};
