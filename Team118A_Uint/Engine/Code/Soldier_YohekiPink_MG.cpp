...
CSoldier_YohekiPink_MG::CSoldier_YohekiPink_MG(LPDIRECT3DDEVICE9 pGraphicDev, E_OBJTAG eObjTag)
	:CMonster(pGraphicDev, eObjTag, L"Soldier_YohekiPink_MG")
{
}

CSoldier_YohekiPink_MG::CSoldier_YohekiPink_MG(const CSoldier_YohekiPink_MG & rhs)
	:CMonster(rhs)
{
}

CSoldier_YohekiPink_MG::~CSoldier_YohekiPink_MG()
{
}

CSoldier_YohekiPink_MG * CSoldier_YohekiPink_MG::Create(LPDIRECT3DDEVICE9 pGraphicDev, E_OBJTAG eObjTag)
{
	CSoldier_YohekiPink_MG* pInstance = new CSoldier_YohekiPink_MG(pGraphicDev, eObjTag);
...
void CSoldier_YohekiPink_MG::Free()
{
	CMonster::Free();
}

HRESULT CSoldier_YohekiPink_MG::Ready_Object()
{
...
_int CSoldier_YohekiPink_MG::Start_Object(const _float & fTimeDelta)
{
...
_int CSoldier_YohekiPink_MG::Update_Object(const _float & fTimeDelta)
{
...
_int CSoldier_YohekiPink_MG::LateUpdate_Object(const _float & fTimeDelta)
{
...
void CSoldier_YohekiPink_MG::Render_Object(_int iPass)
{
	CMonster::Render_Object(iPass);
}

void CSoldier_YohekiPink_MG::Set_Constantable()
{
	CMonster::Set_Constantable();
}

void CSoldier_YohekiPink_MG::OnEnable()
{
	CMonster::OnEnable();
}

void CSoldier_YohekiPink_MG::OnDisable()
{
	CMonster::OnDisable();
}

void CSoldier_YohekiPink_MG::OnDestroy()
{
	CMonster::OnDestroy();
}

void CSoldier_YohekiPink_MG::Trigger_Attack_1()
{
	Hit_Target();
