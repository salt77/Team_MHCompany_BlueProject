...
CSoldier_Helmet_SG::CSoldier_Helmet_SG(LPDIRECT3DDEVICE9 pGraphicDev, E_OBJTAG eObjTag)
	:CMonster(pGraphicDev, eObjTag, L"Soldier_Helmet_SG")
{
}

CSoldier_Helmet_SG::CSoldier_Helmet_SG(const CSoldier_Helmet_SG & rhs)
	:CMonster(rhs)
{
}

CSoldier_Helmet_SG::~CSoldier_Helmet_SG()
{
}

CSoldier_Helmet_SG * CSoldier_Helmet_SG::Create(LPDIRECT3DDEVICE9 pGraphicDev, E_OBJTAG eObjTag)
{
	CSoldier_Helmet_SG* pInstance = new CSoldier_Helmet_SG(pGraphicDev, eObjTag);
...
void CSoldier_Helmet_SG::Free()
{
	CMonster::Free();
}

HRESULT CSoldier_Helmet_SG::Ready_Object()
{
...
_int CSoldier_Helmet_SG::Start_Object(const _float & fTimeDelta)
{
...
_int CSoldier_Helmet_SG::Update_Object(const _float & fTimeDelta)
{
...
_int CSoldier_Helmet_SG::LateUpdate_Object(const _float & fTimeDelta)
{
...
void CSoldier_Helmet_SG::Render_Object(_int iPass)
{
	CMonster::Render_Object(iPass);
}

void CSoldier_Helmet_SG::Set_Constantable()
{
	CMonster::Set_Constantable();
}

void CSoldier_Helmet_SG::OnEnable()
{
	CMonster::OnEnable();
}

void CSoldier_Helmet_SG::OnDisable()
{
	CMonster::OnDisable();
}

void CSoldier_Helmet_SG::OnDestroy()
{
	CMonster::OnDestroy();
}

void CSoldier_Helmet_SG::Trigger_Attack_1()
{
	Hit_Target();
