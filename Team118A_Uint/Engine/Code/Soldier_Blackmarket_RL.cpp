...
CSoldier_Blackmarket_RL::CSoldier_Blackmarket_RL(LPDIRECT3DDEVICE9 pGraphicDev, E_OBJTAG eObjTag)
	:CMonster(pGraphicDev, eObjTag, L"Soldier_Blackmarket_RL")
{
}

CSoldier_Blackmarket_RL::CSoldier_Blackmarket_RL(const CSoldier_Blackmarket_RL & rhs)
	:CMonster(rhs)
{
}

CSoldier_Blackmarket_RL::~CSoldier_Blackmarket_RL()
{
}

CSoldier_Blackmarket_RL * CSoldier_Blackmarket_RL::Create(LPDIRECT3DDEVICE9 pGraphicDev, E_OBJTAG eObjTag)
{
	CSoldier_Blackmarket_RL* pInstance = new CSoldier_Blackmarket_RL(pGraphicDev, eObjTag);
...
void CSoldier_Blackmarket_RL::Free()
{
	CMonster::Free();
}

HRESULT CSoldier_Blackmarket_RL::Ready_Object()
{
...
_int CSoldier_Blackmarket_RL::Start_Object(const _float & fTimeDelta)
{
...
_int CSoldier_Blackmarket_RL::Update_Object(const _float & fTimeDelta)
{
...
_int CSoldier_Blackmarket_RL::LateUpdate_Object(const _float & fTimeDelta)
{
...
void CSoldier_Blackmarket_RL::Render_Object(_int iPass)
{
	CMonster::Render_Object(iPass);
}

void CSoldier_Blackmarket_RL::Set_Constantable()
{
	CMonster::Set_Constantable();
}

void CSoldier_Blackmarket_RL::OnEnable()
{
	CMonster::OnEnable();
}

void CSoldier_Blackmarket_RL::OnDisable()
{
	CMonster::OnDisable();
}

void CSoldier_Blackmarket_RL::OnDestroy()
{
	CMonster::OnDestroy();
}

void CSoldier_Blackmarket_RL::Trigger_Attack_1()
{
	Hit_Target();
