...
CSoldier_RWY_AR::CSoldier_RWY_AR(LPDIRECT3DDEVICE9 pGraphicDev, E_OBJTAG eObjTag)
	:CMonster(pGraphicDev, eObjTag, L"Soldier_RWY_AR")
{
}

CSoldier_RWY_AR::CSoldier_RWY_AR(const CSoldier_RWY_AR & rhs)
	:CMonster(rhs)
{
}

CSoldier_RWY_AR::~CSoldier_RWY_AR()
{
}

CSoldier_RWY_AR * CSoldier_RWY_AR::Create(LPDIRECT3DDEVICE9 pGraphicDev, E_OBJTAG eObjTag)
{
	CSoldier_RWY_AR* pInstance = new CSoldier_RWY_AR(pGraphicDev, eObjTag);
...
void CSoldier_RWY_AR::Free()
{
	CMonster::Free();
}

HRESULT CSoldier_RWY_AR::Ready_Object()
{
...
_int CSoldier_RWY_AR::Start_Object(const _float & fTimeDelta)
{
...
_int CSoldier_RWY_AR::Update_Object(const _float & fTimeDelta)
{
...
_int CSoldier_RWY_AR::LateUpdate_Object(const _float & fTimeDelta)
{
...
void CSoldier_RWY_AR::Render_Object(_int iPass)
{
	CMonster::Render_Object(iPass);
}

void CSoldier_RWY_AR::Set_Constantable()
{
	CMonster::Set_Constantable();
}

void CSoldier_RWY_AR::OnEnable()
{
	CMonster::OnEnable();
}

void CSoldier_RWY_AR::OnDisable()
{
	CMonster::OnDisable();
}

void CSoldier_RWY_AR::OnDestroy()
{
	CMonster::OnDestroy();
}

void CSoldier_RWY_AR::Trigger_Attack_1()
{
	Hit_Target();
