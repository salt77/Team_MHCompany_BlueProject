...
CSoldier_Helmet_AR::CSoldier_Helmet_AR(LPDIRECT3DDEVICE9 pGraphicDev, E_OBJTAG eObjTag)
	:CMonster(pGraphicDev, eObjTag, L"Soldier_Helmet_AR")
{
}

CSoldier_Helmet_AR::CSoldier_Helmet_AR(const CSoldier_Helmet_AR & rhs)
	:CMonster(rhs)
{
}

CSoldier_Helmet_AR::~CSoldier_Helmet_AR()
{
}

CSoldier_Helmet_AR * CSoldier_Helmet_AR::Create(LPDIRECT3DDEVICE9 pGraphicDev, E_OBJTAG eObjTag)
{
	CSoldier_Helmet_AR* pInstance = new CSoldier_Helmet_AR(pGraphicDev, eObjTag);
...
void CSoldier_Helmet_AR::Free()
{
	CMonster::Free();
}

HRESULT CSoldier_Helmet_AR::Ready_Object()
{
...
_int CSoldier_Helmet_AR::Start_Object(const _float & fTimeDelta)
{
...
_int CSoldier_Helmet_AR::Update_Object(const _float & fTimeDelta)
{
...
_int CSoldier_Helmet_AR::LateUpdate_Object(const _float & fTimeDelta)
{
...
void CSoldier_Helmet_AR::Render_Object(_int iPass)
{
	CMonster::Render_Object(iPass);
}

void CSoldier_Helmet_AR::Set_Constantable()
{
	CMonster::Set_Constantable();
}

void CSoldier_Helmet_AR::OnEnable()
{
	CMonster::OnEnable();
}

void CSoldier_Helmet_AR::OnDisable()
{
	CMonster::OnDisable();
}

void CSoldier_Helmet_AR::OnDestroy()
{
	CMonster::OnDestroy();
}

void CSoldier_Helmet_AR::Trigger_Attack_1()
{
	Hit_Target();
