...
CSoldier_Fuuki_MG::CSoldier_Fuuki_MG(LPDIRECT3DDEVICE9 pGraphicDev, E_OBJTAG eObjTag)
	:CMonster(pGraphicDev, eObjTag, L"Soldier_Fuuki_MG")
{
}

CSoldier_Fuuki_MG::CSoldier_Fuuki_MG(const CSoldier_Fuuki_MG & rhs)
	:CMonster(rhs)
{
}

CSoldier_Fuuki_MG::~CSoldier_Fuuki_MG()
{
}

CSoldier_Fuuki_MG * CSoldier_Fuuki_MG::Create(LPDIRECT3DDEVICE9 pGraphicDev, E_OBJTAG eObjTag)
{
	CSoldier_Fuuki_MG* pInstance = new CSoldier_Fuuki_MG(pGraphicDev, eObjTag);
...
void CSoldier_Fuuki_MG::Free()
{
	CMonster::Free();
}

HRESULT CSoldier_Fuuki_MG::Ready_Object()
{
...
_int CSoldier_Fuuki_MG::Start_Object(const _float & fTimeDelta)
{
...
_int CSoldier_Fuuki_MG::Update_Object(const _float & fTimeDelta)
{
...
_int CSoldier_Fuuki_MG::LateUpdate_Object(const _float & fTimeDelta)
{
...
void CSoldier_Fuuki_MG::Render_Object(_int iPass)
{
	CMonster::Render_Object(iPass);
}

void CSoldier_Fuuki_MG::Set_Constantable()
{
	CMonster::Set_Constantable();
}

void CSoldier_Fuuki_MG::OnEnable()
{
	CMonster::OnEnable();
}

void CSoldier_Fuuki_MG::OnDisable()
{
	CMonster::OnDisable();
}

void CSoldier_Fuuki_MG::OnDestroy()
{
	CMonster::OnDestroy();
}

void CSoldier_Fuuki_MG::Trigger_Attack_1()
{
	Hit_Target();
