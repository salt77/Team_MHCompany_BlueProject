...
CYukata_StreetGhostes_SG::CYukata_StreetGhostes_SG(LPDIRECT3DDEVICE9 pGraphicDev, E_OBJTAG eObjTag)
	:CMonster(pGraphicDev, eObjTag, L"Yukata_StreetGhostes_SG")
{
}

CYukata_StreetGhostes_SG::CYukata_StreetGhostes_SG(const CYukata_StreetGhostes_SG & rhs)
	:CMonster(rhs)
{
}

CYukata_StreetGhostes_SG::~CYukata_StreetGhostes_SG()
{
}

CYukata_StreetGhostes_SG * CYukata_StreetGhostes_SG::Create(LPDIRECT3DDEVICE9 pGraphicDev, E_OBJTAG eObjTag)
{
	CYukata_StreetGhostes_SG* pInstance = new CYukata_StreetGhostes_SG(pGraphicDev, eObjTag);
...
void CYukata_StreetGhostes_SG::Free()
{
	CMonster::Free();
}

HRESULT CYukata_StreetGhostes_SG::Ready_Object()
{
...
_int CYukata_StreetGhostes_SG::Start_Object(const _float & fTimeDelta)
{
	CMonster::Start_Object(fTimeDelta);
	return RETURN_OK;
}

_int CYukata_StreetGhostes_SG::Update_Object(const _float & fTimeDelta)
{
...
_int CYukata_StreetGhostes_SG::LateUpdate_Object(const _float & fTimeDelta)
{
	CMonster::LateUpdate_Object(fTimeDelta);
	return RETURN_OK;
}

void CYukata_StreetGhostes_SG::Render_Object(_int iPass)
{
	CMonster::Render_Object(iPass);
}

void CYukata_StreetGhostes_SG::Set_Constantable()
{
	CMonster::Set_Constantable();
}

void CYukata_StreetGhostes_SG::OnEnable()
{
	CMonster::OnEnable();
}

void CYukata_StreetGhostes_SG::OnDisable()
{
	CMonster::OnDisable();
}

void CYukata_StreetGhostes_SG::OnDestroy()
{
	CMonster::OnDestroy();
}

void CYukata_StreetGhostes_SG::Trigger_Attack_1()
{
	Hit_Target();
