...
_bool CClientScene_Cafe::bUniquePrototype = TRUE;
CClientScene_Cafe::CClientScene_Cafe(LPDIRECT3DDEVICE9 pGraphicDev)
	: CScene(pGraphicDev)
{
}

CClientScene_Cafe::~CClientScene_Cafe()
{
}

CClientScene_Cafe * CClientScene_Cafe::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CClientScene_Cafe*	pInstance = new CClientScene_Cafe(pGraphicDev);
...
//최초 Scene들의 정보를 출력
HRESULT CClientScene_Cafe::Ready_Scene()
{
	CScene::Ready_Scene();
	Ready_Prototype();
	Ready_LightInfo();
...
_int CClientScene_Cafe::Start_Scene(const _float & fTimeDelta)
{
...
_int CClientScene_Cafe::Update_Scene(const _float & fTimeDelta)
{
...
_int CClientScene_Cafe::LateUpdate_Scene(const _float & fTimeDelta)
{
...
void CClientScene_Cafe::Render_Scene()
{
}

//가구, 장식용 Raycast = pOutPos로 위치값을 bCol로 광선 충돌 여부를 판단하여 넘겨준다.
//광선 충돌 시 메쉬 행렬 정렬을 따지지 않고 수행한다.
_vec3 CClientScene_Cafe::Raycast(HWND hWnd, const _matrix* pMatWorld, _vec3* pOutPos, LPD3DXMESH pMesh, _bool* bCol)
{
	POINT	ptMouse{};
...
_vec3 CClientScene_Cafe::TriRaycast(HWND hWnd, CSMesh * pMapBufferCom, CTransform * pMapTransCom, _float* pOutDistance, _bool* bCol)
{
	POINT	ptMouse{};
...
_bool CClientScene_Cafe::RayChar(_vec3 * pOutPos)
{
...
void CClientScene_Cafe::Set_UIManagerFunc()
{
	CUI_Manager::GetInstance()->Set_Func_PickFurniture(bind(&CClientScene_Cafe::Set_PickFurniture, this, true));
	CUI_Manager::GetInstance()->Set_Func_RotFurniture(bind(&CClientScene_Cafe::Set_RotFurniture, this, true));
	CUI_Manager::GetInstance()->Set_Func_StoFurniture(bind(&CClientScene_Cafe::Set_StoFurniture, this, true));
	CUI_Manager::GetInstance()->Set_Func_SelFurnitureInfo(bind(&CClientScene_Cafe::Set_SelectFurInfo, this, true));
	CUI_Manager::GetInstance()->Set_Func_AllStoFurniture(bind(&CClientScene_Cafe::Set_AllStoFurniture, this, true));
	CUI_Manager::GetInstance()->Set_Func_CreateFurniturePick(bind(&CClientScene_Cafe::Set_CreateFurPick, this, true));
	CUI_Manager::GetInstance()->Set_Func_CafeInfoAmenity(bind(&CClientScene_Cafe::Set_OpenAmenity, this, true));
	CUI_Manager::GetInstance()->Set_Func_OpenFurInfo(bind(&CClientScene_Cafe::Set_OpenFurInfo, this, true));
	CUI_Manager::GetInstance()->Set_Func_ExitFurInfo(bind(&CClientScene_Cafe::Set_ExitFurInfo, this, true));
	CUI_Manager::GetInstance()->Set_Func_UpdateAmenity(bind(&CClientScene_Cafe::Set_UpdateAmenity, this, true));
	CUI_Manager::GetInstance()->Set_Func_ProfitRecieve(bind(&CClientScene_Cafe::Set_Recieve, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetName(bind(&CClientScene_Cafe::Set_PresetName, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetNameEnd(bind(&CClientScene_Cafe::Set_PresetNameEnd, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetName1(bind(&CClientScene_Cafe::Set_PresetName1, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetName2(bind(&CClientScene_Cafe::Set_PresetName2, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetName3(bind(&CClientScene_Cafe::Set_PresetName3, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetName4(bind(&CClientScene_Cafe::Set_PresetName4, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetName5(bind(&CClientScene_Cafe::Set_PresetName5, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetInit1(bind(&CClientScene_Cafe::Set_PresetInit1, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetSave1(bind(&CClientScene_Cafe::Set_PresetSave1, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetApply1(bind(&CClientScene_Cafe::Set_PresetApply1, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetInit2(bind(&CClientScene_Cafe::Set_PresetInit2, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetSave2(bind(&CClientScene_Cafe::Set_PresetSave2, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetApply2(bind(&CClientScene_Cafe::Set_PresetApply2, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetInit3(bind(&CClientScene_Cafe::Set_PresetInit3, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetSave3(bind(&CClientScene_Cafe::Set_PresetSave3, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetApply3(bind(&CClientScene_Cafe::Set_PresetApply3, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetInit4(bind(&CClientScene_Cafe::Set_PresetInit4, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetSave4(bind(&CClientScene_Cafe::Set_PresetSave4, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetApply4(bind(&CClientScene_Cafe::Set_PresetApply4, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetInit5(bind(&CClientScene_Cafe::Set_PresetInit5, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetSave5(bind(&CClientScene_Cafe::Set_PresetSave5, this, true));
	CUI_Manager::GetInstance()->Set_Func_PresetApply5(bind(&CClientScene_Cafe::Set_PresetApply5, this, true));
	CUI_Manager::GetInstance()->Set_Func_Gift1(bind(&CClientScene_Cafe::Set_Gift1, this, true));
	CUI_Manager::GetInstance()->Set_Func_Gift2(bind(&CClientScene_Cafe::Set_Gift2, this, true));
	CUI_Manager::GetInstance()->Set_Func_Gift3(bind(&CClientScene_Cafe::Set_Gift3, this, true));
	CUI_Manager::GetInstance()->Set_Func_Gift4(bind(&CClientScene_Cafe::Set_Gift4, this, true));
	CUI_Manager::GetInstance()->Set_Func_Gift5(bind(&CClientScene_Cafe::Set_Gift5, this, true));
}

void CClientScene_Cafe::Set_FogEvent()
{
...
void CClientScene_Cafe::Update_FogEvent(const _float & fTimeDelta)
{
	Set_FogEvent();
...
void CClientScene_Cafe::LoadCafeMap(const wstring & wstrFilePath)
{
...
//wstrFilePath를 통해 경로를 받아서 해당 경로에 있는 Load 파일의 정보를 읽어 객체를 생성한다.
void CClientScene_Cafe::LoadCafeFurniture(const wstring & wstrFilePath)
{
	HANDLE hFile = CreateFile(wstrFilePath.c_str(), GENERIC_READ, 0, nullptr, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, nullptr);
	DWORD dwByte = 0;
...
//블럭타일 생성
void CClientScene_Cafe::CreateBlock()
{
...
void CClientScene_Cafe::SelectFurniture()
{
...
void CClientScene_Cafe::PickingFurniture()
{
	if (m_bFurniturePick)
	{
...
void CClientScene_Cafe::MoveFurniture()
{
	//타일
...
void CClientScene_Cafe::RotateFurniture()
{
...
void CClientScene_Cafe::DeleteFurniture()
{
...
void CClientScene_Cafe::PickChar()
{
	if (Management Key_Down(KEY_Tab))
	{
...
void CClientScene_Cafe::MoveChar()
{
	if (!m_pSelChar)
	{
		return;
...
CUI_Object * CClientScene_Cafe::Load_UI_Prefab(wstring wstrPath)
{
...
void CClientScene_Cafe::UI_SelFurInfo()
{
...
void CClientScene_Cafe::UI_CreateFurPick()
{
...
void CClientScene_Cafe::UI_StartAmenityInfo()
{
	if (m_bStartAmenity)
	{
		m_iAmenity = 0;
...
void CClientScene_Cafe::UI_AmenityInfo()
{
...
void CClientScene_Cafe::UI_FurnitureInfo()
{
	if (m_bOpenFurInfo)
	{
		m_vecObstacle_Cafe = Management Get_vecGameObject(E_LAYERTAG::Obstacle, E_OBJTAG::OBJ_Obstacle);
...
void CClientScene_Cafe::UI_DeleteFurnitureInfo()
{
	if (m_bExitFurInfo)
	{
...
void CClientScene_Cafe::UI_UpdateProfit(const _float& fTimeDelta)
{
	if (m_bRecieve)
	{
...
void CClientScene_Cafe::UI_Preset(const _float& fTimeDelta)
{
	if (m_bPresetInit1)
	{
...
void CClientScene_Cafe::UI_PresetSave(_int iIndex)
{
...
void CClientScene_Cafe::UI_PresetApply(_int iIndex, const _float& fTimeDelta)
{
	m_bPresetFog = true;
...
void CClientScene_Cafe::UI_PresetName()
{
...
HRESULT CClientScene_Cafe::Ready_Prototype()
{
	if (bUniquePrototype)
	{
...
//최초 한번 수행. 조명을 설정한다.
HRESULT CClientScene_Cafe::Ready_LightInfo()
{
...
HRESULT CClientScene_Cafe::Ready_SceneObject()
{
	CreateBlock();
...
void CClientScene_Cafe::UI_InputKey()
{
...
void CClientScene_Cafe::CharSound()
{
